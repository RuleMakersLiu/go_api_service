...
type HelloResp struct {
	Message *Common `thrift:"message,1" form:"message" json:"message" query:"message"`
...
var HelloResp_Message_DEFAULT *Common

func (p *HelloResp) GetMessage() (v *Common) {
	if !p.IsSetMessage() {
		return HelloResp_Message_DEFAULT
	}
	return p.Message
}

func (p *HelloResp) GetData() (v []*Data) {
	return p.Data
}
...
func (p *HelloResp) IsSetMessage() bool {
...
func (p *Data) GetName() (v string) {
	return p.Name
}

func (p *Data) GetID() (v int64) {
	return p.ID
}
